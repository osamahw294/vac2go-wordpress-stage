...
define( __NAMESPACE__ . '\PLUGIN_VERSION', '1.58.1' );
...
try {
	...
	// Make the PF container implementation aware of the main container.
	$container_pf->extend( Container::class, function () use ( $container ) {
		return $container;
	} );

	// Make the main container aware of our Plugin Framework container implementation.
